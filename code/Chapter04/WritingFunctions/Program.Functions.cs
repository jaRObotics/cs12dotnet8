...
partial class Program
{
    ...
    {
        for (uint number = 1; number <= 15; number++)
        {
    ...
    static int Factorial(int number)
    {
        ...
        else
        {
            ...
            {
                return number * Factorial(number - 1); //RECURSION IN ACTION!
            }
        }
    }
    ...
    static int FibImperative(uint term)
    {
        ...
        {
            return FibImperative(term - 1) + FibImperative(term - 2); //recursion 
        }
    }
    ...
    {
        0 => throw new ArgumentOutOfRangeException(), //EB-M
        1 => 0,
        2 => 1,
        _ => FibFunctional(term - 1) + FibFunctional(term - 2) //recursion 
    };
