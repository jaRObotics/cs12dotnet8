...
public partial class Person : object
{
    ...
    public List<Person> Children = new(); //List<Person> inside Person class!!!! why here?
    //THIS CREATES A RELATION - I can create this class from the current class
    ...
    {
        Name = initialName;
        HomePlanet = homePlanet; //will be overwritten in ctor (even if value assigned at declaration)
        Instantiated = DateTime.Now;
    }
    ...
    public void PassingParameters(int w, in int x, ref int y, out int z) //in, ref, out 
    {
    ...
    public (string, int, int) GetFruit()
    {
        return ("Apples", 5, 77);
    }
    ...
    public void Deconstruct(out string? name, out DateTimeOffset dob) 
        //special function  -can be implicitly executed in othe classes on types Person
    {
        name = Name;
        dob = Born;
    }
    ...
    public static int Factorial(int number)
    {
        ...
        int localFactorial(int localNumber) // Local function.
        {
            ...
            return localNumber * localFactorial(localNumber - 1); //reccursion 
        }
    }
